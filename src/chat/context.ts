...
export function buildManagerChatContext(
  ...
  addSection(
    ...
    [
      ...
      "This mode is read-only and informational.",
      "You cannot approve plans, execute runs, retry tasks, cancel work, resolve conflicts, clean up worktrees, or merge.",
      "Human approval and later actions must happen through the Duet CLI.",
